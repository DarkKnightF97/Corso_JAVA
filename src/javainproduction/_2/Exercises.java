...
public class Exercises {
    ...
    private static void exercise1() {
        System.out.println("\nExercise 1: ");
        // Your code here
        List <Integer> evenNumbers=                //non capisco perchè se provo a togliere il toList mi da errore
        ourNumbers.stream().filter(n -> n % 2 == 0).collect(Collectors.toList());
    ...
    private static void exercise2() {
        ...
        ourNumbers.stream().filter(n -> n % 2 == 1).collect(Collectors.toSet());
    ...
    private static void exercise4() {
        System.out.println("\nExercise 4");
        //Your code here
        ourNumbers.stream().filter(n -> n % 2 == 0).map(n -> n*2).collect(Collectors.toSet()).forEach(System.out::println);
    }
}