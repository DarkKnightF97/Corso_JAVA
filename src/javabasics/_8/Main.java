...
public class Main {
    ...
    private static void exercise3() {
        ...
        String doubleStrToConvert = "6.9"; // Also this line
    ...
    private static void exercise4() {
        ...
        String startStr = "5";
        // Write your code here
        int startStrInt = Integer.valueOf(startStr);
        startStrInt *= 2;
        startStr = String.valueOf(startStrInt);
        startStr += startStr;
        double startStrDouble = Double.valueOf(startStr) / 3.5;
        System.out.println(Math.floor(startStrDouble));
