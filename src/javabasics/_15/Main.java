...
public class Main {
     ...
     */
    //Modifica questo ciclo while in modo che si interrompa una volta che il nostro currentInvestmentValueEuros raggiunge € 100.000
     //       * <p>
     //* 1b: cambia la stessa linea, ma ora invece di currentInvestmentValueEuros raggiunge €100.000
    //     *
    //   * Facciamolo funzionare per 5 anni OPPURE finché non raggiunge € 15.000 di utilizzo || proprio come un se!
           // */
    private static void exercise1() {
       ...
       // while (Math.ceil(currentInvestmentValueEuros)<= 100_000) {
        while (Math.ceil(currentInvestmentValueEuros) <= 15_000 || (++yearsPast)<= 5){
