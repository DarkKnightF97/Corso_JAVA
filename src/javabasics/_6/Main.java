...
public class Main { public static void main(String[] args) {
    ...
    private static void exercise1() {
        ...
        System.out.println("The square root of value : " + valueSquareRoot);
    ...
    private static void exercise3() {
        ...
        int costPerBurger = 9;
        // Write your code here
        int remainderMoney = totalMoney % costPerBurger;
        System.out.println("Remainder=" + remainderMoney);
    }
    ...
    private static void exercise4Bonus() {
        ...
        // Generates a random number contained in the value
