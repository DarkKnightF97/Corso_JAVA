...
public class Main {
    ...
    private static void exercise2() {
        ...
        // Write your code here
        boolean possibilityToEnter = eurosInPocket >= eurosForEntry;
        boolean ageToEnter = age > 18;
        boolean shoeTypeToEnter = shoeType.equals("fancy");

        if ( shoeTypeToEnter && possibilityToEnter && ageToEnter){
    ...
    private static void exercise3() {
        ...
        //Write your code here
        double ourPercentAge = (ourTestScore * 100) / maxTestScore;


        if (ourPercentAge >= ((ourTestScore + 1) * 100) / maxTestScore || !isTestRetry){
            System.out.println("A");
        } else if (ourPercentAge == ourPercentAge || !isTestRetry){
            System.out.println("B");
        }
        else if (ourPercentAge >= ((ourTestScore - 1) * 100) / maxTestScore || !isTestRetry){
            System.out.println("C");
        }
        else if (ourPercentAge >= ((ourTestScore - 2) * 100) / maxTestScore || !isTestRetry){
